...
include::http://raw.githubusercontent.com/simevidas/simevidas.github.io/master/_includes/diary.adoc[The diary]


'''

include::https://rawgit.com/simevidas/simevidas.github.io/master/_includes/diary.adoc[The diary]


'''

include::http://rawgit.com/simevidas/simevidas.github.io/master/_includes/diary.adoc[The diary]
