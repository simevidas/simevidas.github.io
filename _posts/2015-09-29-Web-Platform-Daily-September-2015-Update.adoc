...
I plan to implement curated pages for certain features and topics (like “Pointer Events”, “Client Hints”, “Rendering performance”, etc.). These would bring together select entries from the all releases that have been published on WPD so far.
